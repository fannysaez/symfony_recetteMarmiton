...
| Section                                                                  | Lien                                                                 |
|--------------------------------------------------------------------------|----------------------------------------------------------------------|
| Installation des dépendances via npm                                     | [#installation-des-dépendances-via-npm](#installation-des-dépendances-via-npm) |
| Importer Bootstrap via Importmap                                         | [#importer-bootstrap-via-importmap](#importer-bootstrap-via-importmap) |
| Commandes Symfony 7 CLI - Principales                                    | [#commandes-symfony-7-cli---principales](#commandes-symfony-7-cli---principales) |
| Commandes Symfony 7 - Création de commandes et filtres personnalisés      | [#commandes-symfony-7---création-de-commandes-et-filtres-personnalisés](#commandes-symfony-7---création-de-commandes-et-filtres-personnalisés) |
| Revenir en arrière après avoir modifié une entité                         | [#revenir-en-arrière-après-avoir-modifié-une-entité](#revenir-en-arrière-après-avoir-modifié-une-entité) |
| Outils de débogage principaux                                            | [#outils-de-débogage-principaux](#outils-de-débogage-principaux)     |
| Mes Projets                                                              | [#mes-projets](#mes-projets)                                         |
